# Spring FS Pet Clinic Prompts

In this repository is a collection of prompts which can be used with a coding agent such as Junie, Cursor, Claude Code.
to generate a complete Spring Pet Store Project.

For additional information about the Spring Pet Clinic see this [overview document.](spring-petclinic.md)

See the [Pet Clinic Prompts Document](petclinic-prompts.md) for prompts you may use to create a Spring Pet Clinic Application.

Refer to the document [guidelines.md](guidelines.md) customize the behavior of your agent. 
...
* [Copilot](https://code.visualstudio.com/docs/copilot/copilot-customization#_custom-instructions)
